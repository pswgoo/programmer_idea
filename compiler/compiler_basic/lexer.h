...
enum TokenType {
	NON_TERMINAL, KEY_IF, KEY_ELSE, KEY_WHILE, KEY_FOR, 
	KEY_SWITCH, KEY_CASE, KEY_STRUCT, KEY_CLASS, KEY_CONST, 
	KEY_DO, KEY_GOTO, KEY_BOOL, KEY_CHAR, KEY_INT, 
	KEY_FLOAT, KEY_DOUBLE, 

	OP_MINUS, OP_ADD, OP_PRODUCT, OP_DIVIDE, 
...
const std::vector<std::string> kTokenTypeStr = { 
	...
	"INTEGER", "OP_MINUS", "OP_ADD", "OP_PRODUCT", "OP_DIVIDE", 
	"OP_LEFT_PARENTHESIS", "OP_RIGHT_PARENTHESIS", "OP_GREATER", "OP_LESS", "OP_EQUAL", 
	"OP_GREATER_EQUAL", "OP_LESS_EQUAL", "OP_ASSIGN" 
};
